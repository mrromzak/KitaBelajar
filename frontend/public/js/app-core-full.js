...
function openBadgeModal(b) {
  ...
  overlay.querySelector('.badge-modal-icon').innerHTML = iconSrc
    ? `<img src="${iconSrc}" alt="" style="width:160px;height:160px;object-fit:contain" onerror="this.onerror=null;this.outerHTML='<span style=\\'font-size:64px\\'>🏅</span>'">`
...
// ============================================================
//  Analitik Guru — sinyal per murid
// ============================================================
const AnalitikGuru = (() => {
  ...
  function sembunyikanSemuaTab() {
    ['kelas-stream','kelas-murid-stream','kelas-chat-stream','kelas-penilaian-stream','kelas-kuis-stream','kelas-analitik-stream'].forEach(id => {
      const el = document.getElementById(id);
      if (el) el.style.display = 'none';
    });
    ['tab-materi-btn','tab-kuis-btn','tab-murid-btn','tab-chat-btn','tab-penilaian-btn','tab-analitik-btn'].forEach(id => {
      const el = document.getElementById(id);
